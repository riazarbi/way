...
if [ ! -f "$PROJECT_REPO/stories/$USER_STORY/user-story.md" ]; then
    ...
    claude --dangerously-skip-permissions "execute /workspace/.way/prompts/00_story.md against user story folder $USER_STORY in project folder $PROJECT_REPO"
    #if ! run_claude_command "claude --dangerously-skip-permissions -p \"execute /workspace/.way/prompts/00_story.md against user story folder $USER_STORY in project folder $PROJECT_REPO\""; then
...
if [ ! -f "$PROJECT_REPO/stories/$USER_STORY/solution-space.md" ]; then
    ...
    claude --dangerously-skip-permissions "execute /workspace/.way/prompts/01_search.md against user story folder $USER_STORY in project folder $PROJECT_REPO"
    #if ! run_claude_command "claude --dangerously-skip-permissions -p \"execute /workspace/.way/prompts/01_search.md against user story folder $USER_STORY in project folder $PROJECT_REPO\""; then
...
if [ ! -f "$PROJECT_REPO/stories/$USER_STORY/target-solution.md" ]; then
    ...
    claude --dangerously-skip-permissions "execute /workspace/.way/prompts/02_select.md against user story folder $USER_STORY in project folder $PROJECT_REPO"
    #if ! run_claude_command "claude -p --dangerously-skip-permissions \"execute /workspace/.way/prompts/02_select.md against user story folder $USER_STORY in project folder $PROJECT_REPO\""; then
...
if [ ! -f "$PROJECT_REPO/stories/$USER_STORY/solution-specification.md" ]; then
    ...
    claude --dangerously-skip-permissions "execute /workspace/.way/prompts/03_define.md against user story folder $USER_STORY in project folder $PROJECT_REPO"
    #if ! run_claude_command "claude -p --dangerously-skip-permissions \"execute /workspace/.way/prompts/03_define.md against user story folder $USER_STORY in project folder $PROJECT_REPO\""; then
...
if [ ! -d "$PROJECT_REPO/stories/$USER_STORY/plan" ]; then
    ...
    claude --dangerously-skip-permissions "execute /workspace/.way/prompts/04_plan.md against user story folder $USER_STORY in project folder $PROJECT_REPO"
    #if ! run_claude_command "claude -p --dangerously-skip-permissions \"execute /workspace/.way/prompts/04_plan.md against user story folder $USER_STORY in project folder $PROJECT_REPO\""; then
...
while true; do
    ...
    claude --dangerously-skip-permissions "execute /workspace/.way/prompts/05_decompose.md against user story folder $USER_STORY in project folder $PROJECT_REPO"
    #if ! run_claude_command "claude -p --dangerously-skip-permissions \"execute /workspace/.way/prompts/05_decompose.md against user story folder $USER_STORY in project folder $PROJECT_REPO\""; then
